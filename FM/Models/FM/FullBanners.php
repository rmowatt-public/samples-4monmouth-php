...
class FM_Models_FM_FullBanners extends FM_Models_BaseModel {

	protected $_tableName = 'fullbanners';
	...
	public function getLike($string){
		$sql = "SELECT * from {$this->_dbName}.{$this->_tableName} b WHERE name LIKE '%{$string}%'";
		return $this->getMultipleRows($sql);
	}
