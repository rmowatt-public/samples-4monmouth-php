...
class FM_Forms_Root_OurServices extends Zend_Form {
	...
	public function __construct($options = null) {
		...
		$this->addElement('textarea', 'statement', array('label'=>'about us statement:', 'name'=>'statement', 'rows'=>6, 'cols'=>50, 'style'=>'width:400px;','required'=>1));
