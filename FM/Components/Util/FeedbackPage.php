<?php
Zend_Loader::loadClass ( 'FM_Models_FM_FeedbackPage' );
Zend_Loader::loadClass ( 'FM_Components_BaseComponent' );

class FM_Components_Util_FeedbackPage extends FM_Components_BaseComponent{
	...
	public function __construct($keys = null) {
		if(is_array($keys)) {
			$aboutUsModel = new FM_Models_FM_FeedbackPage();
